...
Dimensionality reduction (PCA, UMAP, t-SNE), 2D/3D scatter plots,
silhouette plots, elbow curves, radar charts, heatmaps, dendrograms,
consensus matrices, and cluster distribution analysis.
"""
