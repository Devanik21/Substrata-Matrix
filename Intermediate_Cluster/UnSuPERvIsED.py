...
if page == "🏠 Home":
    ...
    with col_anim:
        ...
        fig_demo.update_layout(
            ...
            xaxis=dict(showgrid=False, zeroline=False, showticklabels=False, title="", range=[-9, 10.5]), 
            yaxis=dict(showgrid=False, zeroline=False, showticklabels=False, title="", range=[-10.5, 9]),
            updatemenus=[dict(
