...
if page == "🏠 Home":
    ...
    with col_anim:
        ...
        fig_demo.update_layout(
            ...
            xaxis=dict(showgrid=False, zeroline=False, showticklabels=False, title="", range=[-7.5, 8.5]), 
            yaxis=dict(showgrid=False, zeroline=False, showticklabels=False, title="", range=[-8.5, 7.5]),
            updatemenus=[dict(
